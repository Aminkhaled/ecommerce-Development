...
<?php include('includes/nav-left.php') ?>
    ...
    <div class="page-wrapper">
                                ...
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table  class="table  top-countries" >
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="libraries/dist/img/country/gb.svg" alt="user_img">
                                                </td>
                                                <td>
                                                    United Kingdom
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="libraries/dist/img/country/my.svg" alt="user_img">
                                                </td>
                                                <td>
                                                    Malaysia
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="libraries/dist/img/country/au.svg" alt="user_img">
                                                </td>
                                                <td>
                                                    Australia
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="libraries/dist/img/country/us.svg" alt="user_img">
                                                </td>
                                                <td>
                                                    United States
                                                </td>
        ...
        <footer class="footer container-fluid pl-30 pr-30">
            <div class="row">
                <div class="col-sm-5">
                    <a href="#" class="brand mr-30"><img src="libraries/dist/img/logo-sm.png" alt="logo"/></a>
